/*
footer.js: CrunchNet Dashboard footer script
...
// Adds footer to page
document.write('\
\    <footer style="background-color: hotpink; padding: 10px;">\
\        <p style="font-size: 15px; color: white;">Version 0.1<br />Copyright (c) 2018 Kade Burnside</p>\
\    </footer>\
');
